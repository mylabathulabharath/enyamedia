...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      category: 'AI Enhancement Services',
      description:
        'Seamlessly inject new people into existing scenes using advanced AI technology. Add characters to historical footage, photos, or videos with realistic integration that maintains scene consistency and natural appearance.',
      highlights: [
        'Add new people to existing scenes',
        'Realistic character integration',
        'Maintain scene consistency',
        'Natural appearance and lighting',
      ],
      hasComparison: false,
      mediaType: 'image',
      mediaUrl: '/injection.png',
      gradient: 'from-orange-500/20 via-red-500/20 to-pink-500/20',
    },
    {
      name: 'Content/Media Curation',
      category: 'Content Services',
      description:
        'Professional content and media curation services for your projects. Organize, select, and present media content with precision, ensuring the right content reaches the right audience at the right time.',
      highlights: [
